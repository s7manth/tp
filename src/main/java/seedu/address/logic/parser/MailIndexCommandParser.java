...
public class MailIndexCommandParser implements Parser<MailIndexCommand> {
     ...
     */
    public MailIndexCommand parse(String args) throws ParseException {
        try {
            Index index = ParserUtil.parseIndex(args);
            return new MailIndexCommand(index);
        } catch (ParseException pe) {
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, MailIndexCommand.MESSAGE_USAGE), pe);
        }
    }
}
