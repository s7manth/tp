...
public class ParserUtilTest {
    ...
    private static final String INVALID_STUDENT_NUMBER = "z23456B";
    private static final String INVALID_ADDRESS = " ";
    private static final String INVALID_MOD = "example.com";
    private static final String INVALID_TAG = "#friend";

    private static final String VALID_NAME = "Rachel Walker";
    private static final String VALID_STUDENT_NUMBER = "A0225771K";
    ...
    public void parseAddress_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseMod(INVALID_ADDRESS));
    }
